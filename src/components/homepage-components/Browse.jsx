...
const Browse = () => {
  ...
  // Sample data array - add or modify as needed
  const categoryData = [
    { id: 1, name: "Casual", path: "/categorypage" },
    { id: 2, name: "Formal" },
    { id: 3, name: "Party" },
    { id: 4, name: "Gym" },
    // { id: 5, name: "Travel" }, // New data
    // { id: 6, name: "Beach" },  // New data
    // { id: 7, name: "Office" }, // New data
    // { id: 8, name: "Sports" }, // New data
  ];
  ...
  // Function to split data into rows of two
  const createGridRows = (items) => {
    const rows = [];
    for (let i = 0; i < items.length; i += 2) {
      rows.push(items.slice(i, i + 2));
